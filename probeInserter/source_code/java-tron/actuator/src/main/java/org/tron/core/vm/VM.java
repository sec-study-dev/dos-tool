...
public class VM {
  ...
  public static void recordInfo(String name, long time, long memory, long energy) {
    String timeFolderPath = "./time";
    String timePerCostFolderPath = "./timePerCost";
    String memoryFolderPath = "./memory";
    String memoryPerCostFolderPath = "./memoryPerCost";
    DecimalFormat df = new DecimalFormat("#.##");
    double timePerCost = (double)time / energy;
    double memoryPerCost = (double)memory / energy;

    try {
        FileWriter fw = new FileWriter(timeFolderPath + "/" + name + ".txt");
    ...
    try {
        FileWriter fw = new FileWriter(timePerCostFolderPath + "/" + name + ".txt");
        fw.write(df.format(timePerCost));
        fw.close();
    } catch (IOException e) {
        e.printStackTrace();
    }
    ...
    try {
        FileWriter fw = new FileWriter(memoryFolderPath + "/" + name + ".txt");
    ...
    try {
        FileWriter fw = new FileWriter(memoryPerCostFolderPath + "/" + name + ".txt");
        fw.write(df.format(memoryPerCost));
        fw.close();
    } catch (IOException e) {
        e.printStackTrace();
    }
    ...
    try {
      ...
      switch (op) {
        ...
        case STOP: {
          ...
          recordInfo("STOP", timeUsage, memoryUsage, energyCost);
        }
        break;
        case ADD: {
          Runtime runtime = Runtime.getRuntime();
          ...
          recordInfo("ADD", timeUsage, memoryUsage, energyCost);
        ...
        case MUL: {
          ...
          long timeUsage = endTime - startTime;
          long memoryUsage = memoryAfter - memoryBefore;
          recordInfo("MUL", timeUsage, memoryUsage, energyCost);
        }
        break;
        case SUB: {
          Runtime runtime = Runtime.getRuntime();
          ...
          long timeUsage = endTime - startTime;
          long memoryUsage = memoryAfter - memoryBefore;
          recordInfo("SUB", timeUsage, memoryUsage, energyCost);
        }
        break;
        case DIV: {
          Runtime runtime = Runtime.getRuntime();
          ...
          long timeUsage = endTime - startTime;
          long memoryUsage = memoryAfter - memoryBefore;
          recordInfo("DIV", timeUsage, memoryUsage, energyCost);
        }
        break;
        case SDIV: {
          Runtime runtime = Runtime.getRuntime();
          ...
          long timeUsage = endTime - startTime;
          long memoryUsage = memoryAfter - memoryBefore;
          recordInfo("SDIV", timeUsage, memoryUsage, energyCost);
        }
        break;
        case MOD: {
          DataWord word1 = program.stackPop();
